...
class BillPT
{
    ...
    public function showSyncStockPage()
    {
        if (isset($_GET['tab']) && $_GET['tab'] == 'sync-stock') {
            return true;
        }
        return false;
    }

    public function showSyncLogPage()
    {
        if (isset($_GET['tab']) && $_GET['tab'] == 'synclog') {
            return true;
        }
        return false;
    }
    ...
    {
        return $this->api->getItemsMetaStructure();
    }
    ...
    public function populateSelectGeneral($populate, $selected, $default, $data_object = false)
    {
        echo '<option></option>';
        if($selected == null || $selected == ""){
            $selected = $default;
        }
        foreach ($populate as $value => $text) {
            if( $data_object ){
                $linha    = json_decode($text->value);
                $value    = isset($linha->codigo) ? $linha->codigo : $linha->id;
                $text     = isset($linha->motivo) ? $linha->codigo . ' ' . $linha->motivo : $linha->nome;
            }
            
            $confirmed = ($selected == $value) ? 'selected="selected"' : '';
            echo '<option ' . $confirmed . ' value="' . $value . '">' . $text . '</option>';
        }
    }
  ...
  <div class="notification">
    ...
    <div class="columns">
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __('Tipo Documento', "bill-faturacao"); ?>
          </label>
          <div class="control">
    ...
    <div class="columns">
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __("Data", "bill-faturacao"); ?>
          </label>
          <div class="control">
            <div class="is-fullwidth">
      ...
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __("Prazo Vencimento", "bill-faturacao") ?>
          </label>
          <div class="control">
            <div class="is-fullwidth">
    ...
    <div class="columns">
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __("Série Documento", "bill-faturacao"); ?>
          </label>
          <div class="control">
            <div class="select is-fullwidth">
    ...
    <div class="columns">
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __("Método Expedicao", "bill-faturacao"); ?>
          </label>
          <div class="control">
            <div class="select is-fullwidth">
      ...
      <div class="column">
        <div class="field">
          <label class="label">
            <?php echo __("Envio por e-mail", "bill-faturacao"); ?>
          </label>
          <div class="control">
            <label class="checkbox">
              <input <?php $this->isChecked('envio_email', $config_por_defeito)?> type="checkbox" name="envio_email" value="1">
              <?php echo __("Automático para e-mail do cliente", "bill-faturacao"); ?>
                </a>
            </label>
          </div>
        </div>
...
public function printUserCompanyInfo($meta)
{
    ...
    <div class="notification">
      <div class="columns">
        <div class="column">
          <div class="field">
            <label class="label">
              <?php echo __("Nome Empresa / Cliente", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
        ...
        <div class="column">
          <div class="field">
            <label class="label">
              <?php echo __("NIF", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
      ...
      <div class="columns">
        <div class="column">
          <div class="field">
            <label class="label">
              <?php echo __("E-mail", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
        ...
        <div class="column">
          <div class="field">
            <label class="label">
              <?php echo __("Código no Bill (se já existir)", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
      ...
      <div class="field">
        <label class="label">
          <?php echo __("Morada", "bill-faturacao"); ?>
        </label>
        <div class="control">
          <div class="is-fullwidth">
            <textarea class="textarea" name="contato[morada]" cols="30" rows="5"><?php 
            $meta['_billing_address_1'] = isset( $meta['_billing_address_1'] ) ? $meta['_billing_address_1'] : '';
            $meta['_billing_address_2'] = isset( $meta['_billing_address_2'] ) ? $meta['_billing_address_2'] : '';
            echo trim($meta['_billing_address_1'] . ' ' . $meta['_billing_address_2']); ?></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="columns">
        <div class="column is-4">
          <div class="field">
            <label class="label">
              <?php echo __("Pais", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="select is-fullwidth">
    ...
    foreach ($this->api->getCountriesList() as $code => $name) {
        ...
        <div class="column is-4">
          <div class="field">
            <label class="label">
              <?php echo __("Código Postal", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
        ...
        <div class="column is-4">
          <div class="field">
            <label class="label">
              <?php echo __("Cidade", "bill-faturacao"); ?>
            </label>
            <div class="control">
              <div class="is-fullwidth">
    ...
    echo '<div class="column">'; ?>
      <div class="notification">
        <?php if (!$obrigatorio) {?>
          ...
          <?php }?>
            ...
            <br/>
            <?php echo __("Dados da entrega", "bill-faturacao"); ?>
      </div>
      <div class="notification moradas" <?php echo $obrigatorio ? "" : "style='display:none'"; ?>>
        <div class="field">
          ...
          <div class="control">
            <div class="is-fullwidth">
              <textarea class="textarea" <?php echo $obrigatorio ? "required" : ""; ?><?php echo $obrigatorio ? "name='descarga_morada'" : ""; ?> data-name="descarga_morada" cols="30" rows="5">
                  <?php 
                   $meta['_shipping_address_1'] = isset( $meta['_shipping_address_1'] ) ? $meta['_shipping_address_1'] : '';
                   $meta['_shipping_address_2'] = isset( $meta['_shipping_address_2'] ) ? $meta['_shipping_address_2'] : '';
                  echo trim($meta['_shipping_address_1'] . ' ' . $meta['_shipping_address_2']); ?></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="columns">
          <div class="column is-4">
            <div class="field">
              ...
              <div class="control">
                <div class="select is-fullwidth">
                  <select <?php echo $obrigatorio ? "required" : ""; ?>
                    <?php echo $obrigatorio ? "name='descarga_pais'" : ""; ?> data-name="descarga_pais">
                      <?php
    foreach ($this->api->getCountriesList() as $code => $name) {
        echo '<option value="' . $code . '"   ' . selected($code, $meta['_billing_country'], false) . '>' . $name . '</option>';
    }?>
          ...
          <div class="column is-4">
            <div class="field">
              ...
              <div class="control">
                <div class="is-fullwidth">
                  <input class="input" <?php echo $obrigatorio ? "required" : ""; ?>
                  <?php echo $obrigatorio ? "name='descarga_codigo_postal'" : ""; ?> type="text" data-name="descarga_codigo_postal" value="
                    <?php echo $meta['_shipping_postcode']; ?>">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="column is-4">
            <div class="field">
              ...
              <div class="control">
                <div class="is-fullwidth">
                  <input class="input" <?php echo $obrigatorio ? "required" : ""; ?>
                  <?php echo $obrigatorio ? "name='descarga_cidade'" : ""; ?> type="text" data-name="descarga_cidade" value="
                    <?php echo $meta['_shipping_city']; ?>">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="columns">
          <div class="column">
            <div class="field">
              <label class="label">
                <?php echo __("Data de Descarga", "bill-faturacao"); ?>
              </label>
              <div class="control">
                <div class="is-fullwidth">
                  <input class="input" <?php echo $obrigatorio ? "required" : ""; ?>
                  <?php echo $obrigatorio ? "name='data_descarga'" : ""; ?> type="datetime-local" data-name="data_descarga">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="notification">
          <?php if (!$obrigatorio) {?>
            ...
            <?php }?>
              ...
              <br/>
              <?php echo __("Dados de onde é enviado.", "bill-faturacao"); ?>
        </div>
        <div class="notification moradas" <?php echo $obrigatorio ? "" : "style='display:none'"; ?>>
          <div class="field">
            <label class="label">
            ...
            <div class="control">
              <div class="is-fullwidth">
                <textarea <?php echo $obrigatorio ? "required" : ""; ?>
                  <?php echo $obrigatorio ? "name='carga_morada'" : ""; ?> class="textarea" data-name="carga_morada" cols="30" rows="5"></textarea>
              </div>
            </div>
          </div>
            ...
            <div class="column is-4">
              <div class="field">
                ...
                <div class="control">
                  <div class="select is-fullwidth">
                    <select <?php echo $obrigatorio ? "required" : ""; ?>
                      <?php echo $obrigatorio ? "name='carga_pais'" : ""; ?> data-name="carga_pais">
                        <?php
    foreach ($this->api->getCountriesList() as $code => $name) {
        echo '<option value="' . $code . '"   ' . selected($code, $meta['_shipping_country'], false) . '>' . $name . '</option>';
            ...
            <div class="column is-4">
              <div class="field">
                ...
                <div class="control">
                  <div class="is-fullwidth">
                    <input <?php echo $obrigatorio ? "required" : ""; ?>
                    <?php echo $obrigatorio ? "name='carga_codigo_postal'" : ""; ?> class="input" type="text" data-name="carga_codigo_postal" value="">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="column is-4">
              <div class="field">
                ...
                <div class="control">
                  <div class="is-fullwidth">
                    <input <?php echo $obrigatorio ? "required" : ""; ?>
                    <?php echo $obrigatorio ? "name='carga_cidade'" : ""; ?> class="input" type="text" data-name="carga_cidade" value="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="columns">
            <div class="column">
              <div class="field">
                <label class="label">
                  <?php echo __("Data de Carga", "bill-faturacao"); ?>
                </label>
                <div class="control">
                  <div class="is-fullwidth">
                    <input <?php echo $obrigatorio ? "required" : ""; ?>
                    <?php echo $obrigatorio ? "name='data_carga'" : ""; ?> class="input" type="datetime-local" data-name="data_carga">
                  </div>
                </div>
              </div>
            </div>
...
public function printCurrencyTable($meta)
{
    echo '<div class="column">'; ?>
          ...
          <div class="notification">
            <strong><?php echo __("Moeda alternativa", "bill-faturacao"); ?></strong>
            <br/><span class="tag is-danger"><?php echo __("Atenção", "bill-faturacao"); ?></span>
            <?php echo __("Todos os documentos são emitidos", "bill-faturacao"); ?> <strong><?php echo __("em Euros", "bill-faturacao"); ?></strong>.
              <?php echo __("Pelo que a moeda do seu Woocommerce por defeito deverá ser euros. No entanto poderá mostrar o total no fim do documento numa moeda alternativa.", "bill-faturacao"); ?>
          </div>
          ...
          <div class="notification">
            <div class="columns">
              <div class="column">
                <div class="field">
                  <label class="label">
                    <?php echo __("Moeda", "bill-faturacao"); ?>
                  </label>
                  <div class="control">
                    <div class="select is-fullwidth">
                      <select name="moeda">
    ...
    ?>
              ...
              <div class="column">
                <div class="field">
                  <label class="label">
                    <?php echo __("Cambio", "bill-faturacao"); ?>
                  </label>
                  <div class="control">
                    <div class="is-fullwidth">
...
public function createDocument()
{
    ...
    if (isset($_POST['criar_documento'])) {
        ...
        if ( isset($_POST['contato']['morada']) 
        && strlen(trim($_POST['contato']['morada'])) > 2
        && isset($_POST['contato']['codigo_postal']) 
        && strlen(trim($_POST['contato']['codigo_postal'])) > 2
        && isset($_POST['contato']['cidade']) 
        && strlen(trim($_POST['contato']['cidade'])) > 2
        && isset($_POST['contato']['pais']) 
        && strlen(trim($_POST['contato']['pais'])) > 1 ) {
          #OVERWRITE ADDRESS
          $_POST['morada'] = $_POST['contato']['morada'];
          $_POST['codigo_postal'] = $_POST['contato']['codigo_postal'];
          $_POST['cidade'] = $_POST['contato']['cidade'];
          $_POST['pais'] = $_POST['contato']['pais'];
        }
...
public function createItems($produtos)
{
    ...
    foreach ($produtos as $key => $produto) {
        ...
        $product_id   = isset($produtos[$key]['product_id']) ? sanitize_text_field($produtos[$key]['product_id']) : '';
        $variation_id = isset($produtos[$key]['variation_id']) ? sanitize_text_field($produtos[$key]['variation_id']) : '';
...
include __DIR__ . '/templates/invoicecss.php';
