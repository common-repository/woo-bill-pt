...
{
	return $this->request('GET', 'items/all', $params);
}
...
public function getItemsMetaStructure($params = [])
{
	return $this->request('GET', 'items/meta/estrutura', $params);
}

public function createItemsMetaStructure($params = [])
{
	return $this->request('POST', 'items/meta/estrutura', $params);
}
...
{
	return $this->request('GET', 'data-hora');
}
