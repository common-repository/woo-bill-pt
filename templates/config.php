          ...
          <div class="column">
            <div class="box">
              ...
              <p class="subtitle is-6"><strong><?php echo __("Configurar Token", "bill-faturacao"); ?></strong>
                <br />
                <?php echo __("Deverá logar com os seus dados para obter o token. Deverá ligar a API para o seu utilizador nas permissões do Bill.pt", "bill-faturacao"); ?>
              </p>
              <table class="widefat">
                <thead>
                  <tr>
                    <th>
                      <?php echo __("Email", "bill-faturacao"); ?>
                    </th>
                    <th>
                      <?php echo __("Password", "bill-faturacao"); ?>
                    </th>
                    <th>
                      <?php echo __("Action", "bill-faturacao"); ?>
                    </th>
                    <th>
                      <?php echo __("State", "bill-faturacao"); ?>
                    </th>
                  </tr>
                </thead>
                <tfoot>
            ...
            <div class="box">
              <p class="subtitle is-6"><strong><?php echo __("Base de dados", "bill-faturacao"); ?></strong>
                <br />
                <?php echo __("Tenha a certeza que actualizou todos os dados antes de começar a Faturar.", "bill-faturacao"); ?>
              </p>
              <table class="widefat">
                <thead>
                  <tr>
                    <th>
                      <?php echo __("Dados", "bill-faturacao"); ?>
                    </th>
                    <th>
                      <?php echo __("Estado", "bill-faturacao"); ?>
                    </th>
                    <th>
                      <?php echo __("Update", "bill-faturacao"); ?>
                    </th>
                  </tr>
                </thead>
                <tfoot>
                ...
                <tbody>
                  <tr>
                    <td>
                      <?php echo __("Lojas", "bill-faturacao"); ?>
                    </td>
                    <td>
                      <?php $bill->vazio($dados_gerais['loja']); ?>
                    </td>
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=loja" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <?php echo __("Séries", "bill-faturacao"); ?>
                    </td>
                    <td>
                      <?php $bill->vazio($dados_gerais['serie']); ?>
                    </td>
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=serie" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=tipo_documento" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=unidade_medida" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=metodo_entrega" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=metodo_pagamento" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=imposto" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a class="button-secondary" href="admin.php?page=bill_settings&update_config=isencao" title="All Attendees">
                        <?php echo __("Update", "bill-faturacao"); ?>
                      </a>
                    </td>
                  </tr>
          ...
          <div class="column">
            ...
            <div class="box">
              <p class="subtitle is-6"><strong><?php echo __("Valores por defeito", "bill-faturacao"); ?></strong>
                <br />
                <?php echo __("Poderá configurar alguns valores por defeito para tornar a emissão dos documentos mais simples.", "bill-faturacao"); ?>
              </p>
              <p><strong><?php echo __("Código Portes Envio:", "bill-faturacao"); ?></strong>
                <?php echo __("Este deverá ser o código do Bill do Serviço de envio. Se não colocar nenhum será criado um novo automáticamente na primeira fatura.", "bill-faturacao"); ?>
              </p>
              <br />
              <form method="POST">
                ...
                <div class="columns">
                  <div class="column">
                    <div class="field">
                      <label class="label is-danger">
                        <?php echo __("Bill API MODO", "bill-faturacao"); ?>
                      </label>
                      <div class="control">
                  ...
                  <div class="column">
                    <div class="field">
                      <label class="label">
                        <?php echo __("Debug (apenas para programadores)", "bill-faturacao"); ?>
                      </label>
                      <div class="control">
                        <div class="select is-fullwidth">
                ...
                <div class="columns">
                  <div class="column">
                    <div class="field">
                      <label class="label">
                        <?php echo __("Código Portes de Envio", "bill-faturacao"); ?>
                      </label>
                      <div class="control">
                  ...
                  <div class="column">
                    <div class="field">
                      <label class="label">
                        <?php echo __("Motivo Isenção", "bill-faturacao"); ?>
                      </label>
                      <div class="control">
                        <div class="select is-fullwidth">
                ...
                <div class="columns">
                  <div class="column">
                    <div class="field">
                      <label class="label">
                        <?php echo __("Unidade Medida", "bill-faturacao"); ?>
                      </label>
                      <div class="control">
                        <div class="select is-fullwidth">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <label class="checkbox">
                          <input <?php $bill->isChecked('envio_email', $config_por_defeito) ?> type="checkbox" name="envio_email" value="1">
